...
- [ ] 8. Manifest Persistence (Atomic JSON I/O)
...
- [ ] 9. File Watcher (notify integration)
...
- [ ] 10. Change Reconciler (Diff + Propagate)
...
- [ ] 11. Workspace — Catalog ↔ Materializer ↔ Watcher Integration
